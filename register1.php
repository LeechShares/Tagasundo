...
<form method="post" action="register.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" enctype="multipart/form-data">
<h2 class="w3-center">Register</h2>
 
  <div class="w3-panel w3-pale-green w3-bottombar w3-border-green w3-border">
   <?php if (isset($_GET['error'])) : ?>
        <p style="color: red;"><?php echo $_GET['error']; ?></p>
    <?php endif; ?><p><strong>Note:</strong>  PM mo admin ng sundo  para ma approved yung account mo at sa Yt at fb sa baba link po ilagay nyu</p>
</div>
