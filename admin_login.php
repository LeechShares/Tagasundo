<?php
  include "_ulo.php";
    ?>
 <form method="post" action="process_admin_login.php" class="w3-container w3-card-4 w3-light-grey w3-text-red w3-margin">
<h2 class="w3-center">Admin Login</h2>
 
  <div class="w3-panel w3-pale-red w3-bottombar w3-border-green w3-border">
  <?php
    if (isset($_GET["error"])) {
        $error = $_GET["error"];
    ...
    ?>
  <p><strong>Note:</strong>  We  Need to very if you are the admin</p>
</div>
